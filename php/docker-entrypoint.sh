...
APP_URL="http://project_pemweb.test"
ASSET_URL="http://project_pemweb.test"
...
# Step 11: Export development variables
...
# Step 12: Set REMOTE_HOST default
